...
{
    public class SetRolesForUserCommandHandler(
        IUserRepository userRepository, 
        IRoleRepository roleRepository,
        IUnitOfWork unitOfWork) : IRequestHandler<SetRolesForUserCommand, IExecutionResult>
    {
        private readonly IUserRepository _userRepository = userRepository;
        private readonly IRoleRepository _roleRepository = roleRepository;
        private readonly IUnitOfWork _unitOfWork = unitOfWork;

        public async Task<IExecutionResult> Handle(SetRolesForUserCommand request, CancellationToken cancellationToken)
        {
